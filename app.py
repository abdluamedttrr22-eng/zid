...
# قالب HTML الرئيسي المدمج (يحتوي على كافة الواجهات والصفحات)
LAYOUT = """
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .navbar-brand img { width: 45px; height: 45px; border-radius: 50%; object-fit: cover; margin-left: 10px; }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="/zad-kitchen/menu">
                <!-- لوكو المطعم -->
                <img src="https://via.placeholder.com/150" alt="لوكو مطبخ زاد">
    ...
    <!-- زر الواتساب العائم مع رقم الهاتف المحدث -->
...
def zad_menu():
    ...
    html_content = """
        <div class="text-center mb-5">
            ...
            <!-- رابط خرائط GPS للتوصيل في البصرة -->
